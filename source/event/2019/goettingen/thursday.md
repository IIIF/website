...
<table class="api-table">
  ...
  <tbody>
        {% include conference_slot_row.html time='9:00am - 10:30am' track1Single='32' track2Single='65' track3Single='30' %}
        ...
        {% include conference_slot_row.html rowspan='3' time='1:30pm - 3:00pm' track1='11,16,78' track2='59,57,69' track3='73,34,20' %}

        {% include conference_slot_row.html span='6' time='3:00pm - 3:30pm' title='<b>Break</b>' %}

        {% include conference_slot_row.html rowspan='3' time='3:30pm - 5:00pm' track1='56,29,48' track2='71,8,79' track3='60,68,80'  %}
