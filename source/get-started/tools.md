...
- [Glycerine Workbench](https://glycerine.io/) - A hosted IIIF platform for image hosting, manifest generation, collaborative annotation and publishing. Researchers, curators and students use it to collaborate on image collections and publish research outputs.
