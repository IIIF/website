---
title: IIIF Community Newsletter, Volume 1 Issue 4
author: Sheila Rabun
date: 2017-08-30
tags: [news, newsletter, announcements]
layout: post
excerpt: >
  Community Snapshot, Community Activities and Events, Technical Work, Community Groups,
 ...
 * [IIIF Consortium][iiif-c]: 46 institutions. The IIIF Consortium (IIIF-C) continues to welcome founding members through December 2017 (please email <admin@iiif.io> or see the [IIIF-C FAQ][iiifc-faq] for more information). Welcome to our newest founding members:
    ...
    * [Walter J. Ong, S.J. Center for Digital Humanities at Saint Louis University][slu]

## Announcements and Actions

### IIIF Technology Coordinator Hired
Glen Robson has been appointed the new Technology Coordinator for the IIIF community; he will start in this new role in September, 2017. In this role, Glen will serve as a dedicated expert helping to provision and maintain IIIF’s technical infrastructure and tools (such as the IIIF.io website, and API validators). He will help identify and address IIIF-related technological issues and opportunities as they arise, and act as a general resource to the community to facilitate adoption, new integrations, and other advances. A special part of Glen’s role will be helping new players (IIIF-C members, other institutions, software providers) to become IIIF-compatible. See [full announcement][glen].
...
* **Tuesday, October 10**: [IIIF Showcase - Toronto][toronto-showcase], an afternoon program focused on the basics and benefits of IIIF, followed by an evening reception. Register to attend the showcase at <https://iiifshowcase-toronto.eventbrite.com>
* **Wednesday, October 11 - Friday, October 13**: [IIIF Working Meeting - Toronto][toronto], intended for active IIIF community participants, to make progress on advancing specific aspects of IIIF such as specifications, software, and community development. Register to attend the working meeting at <https://iiif-toronto.eventbrite.com>
...
The Victoria & Albert Museum is hosting two IIIF events on Thursday, November 2, 2017: a morning Showcase geared toward individuals and institutional representatives interested in learning about the basics and benefits of IIIF, and an afternoon technical workshop for sharing among developers already working with IIIF. For more info and to register, [see details][london].

## Recent Community Events and Outreach

### IIIF Bay Area Museums Meet-up, July 2017
On July 18, 47 attendees from 22 institutions in the San Francisco Bay area convened at the San Francisco Museum of Modern Art (SFMOMA) to share and discuss current usage and increased adoption of IIIF. See [more details][sfmoma].

### IIIF in Japan, July 2017
A IIIF event in Tokyo, Japan at the National Institute of Informatics (NII) drew over 120 people from across the region on July 27, 2017, to learn about the basics of IIIF, examples of successful cases of IIIF adoption, available software, challenges, and expectations, and discuss potential for increased IIIF adoption in Japan. [Read more][japan].

### 2017 IIIF Conference, June 2017
The International Image Interoperability Framework (IIIF) Conference in The Vatican, June 5-9, was a success! Presentation slides and session notes can be found in the [IIIF Google Drive][vatican-drive]. Overall, there were:
...
* [Digipalooza][digipalooza], August 2017
...
The [IIIF A/V Technical Specification Group][av-group] continues to discuss issues related to [IIIF Presentation API version 3.0][presi3] which will include a canvas time dimension and other adjustments to accommodate A/V resources within the existing framework. Experimentation for IIIF A/V is underway with [proof of concept tests in the Avalon Media System][avalon-poc] (see a [demo][avalon-demo]), an open source A/V resource management software developed and maintained by Northwestern University and Indiana University libraries, based on Samvera and Fedora technologies. [Proof of concept tests][masahide] have been constructed by Masahide Kanzaki, an expert in Linked Open Data (LOD) and author of several textbooks on LOD in Japan. The British Library is also [experimenting with IIIF A/V][bl-poc]. As part of the ongoing “Save Our Sounds” project at the British Library, with a grant from The Andrew W. Mellon Foundation, representatives from the IIIF A/V Technical Specification Group will be meeting in September at the Getty Center in Los Angeles to review progress and discuss next steps. The group will meet again at the [IIIF Working Meeting in Toronto][toronto], October 11-13. Updates from the IIIF A/V Technical Specification Group can be found on the [IIIF Discuss email list][iiif-discuss]. Independent experiments are encouraged and the group welcomes any and all feedback via the email list.

### Discovery of IIIF Resources
The [IIIF Discovery Technical Specification Group][discovery-group] recently finished a review of discovery-related use cases in the [iiif-stories GitHub][iiif-stories] repository, to refine the scope of work. A recent survey by Brumfield Labs of the various ways in which linking properties are being used in manifests across the IIIF community has revealed a need for clarified documentation in version 3.0 of the IIIF Presentation API. The group is working towards identifying a preferred mechanism for crawling and harvesting IIIF collections and objects, and will make plans for moving forward at the [IIIF Working Meeting in Toronto][toronto], October 11-13. Work on formalizing the import of IIIF resources into viewers from existing discovery environments is planned for the fall.
...
* Colby College Museum of Art has added IIIF support to their collections (see example)
...
* Georgetown experimenting with [ways to present content from DSpace repository in a IIIF viewer][georgetown]
...
* [Linked Data Notification plugin for Mirador][witt] by Jeffrey Witt  at Loyola University Maryland
* [UCD image cropping/manipulation tool][ucd-tool] now available as standalone Mirador plugin
* [IIIF for Storytelling demo][storytelling] by Cogapp
* National Library of Wales [demo of IIIF for digitized journals][nlw-journals]
* [Ambient Archive demo][ambient] shows a holographic exhibition being created using International Image Interoperability Framework (IIIF) content
* [IIIF for digital microscopy images][microscopy] demo for reviewing cellular images acquired from High Content Screening (HCS) using a digital microscope, using the Cantaloupe image server and the Openseadragon image viewer
* Brumfield Labs [survey of linking properties][linking]
* [Mirador Awesome list][mirador-awesome]
* Work in progress example project [using OpenSeadragon to review multi-channel digital microscopy images][microscopy2]
* [Wikidata SPARQL query plots the locations of the IIIF Consortium members on a map][sparql], courtesy of Katherine Thornton of Yale
* [Video from Leiden University on the use of IIIF for digitized manuscripts][leiden] (in Dutch)
* [Collection of automatically-tagged images][auto-tag] from the Nationalmuseum Sweden
* ResourceSpace digital asset management software is [planning IIIF integration for version 8.2][resourcespace]
...
* Blog from Apex on [interoperable images and IIIF][apex]
* Article from Smithsonian on [IIIF and Mirador][smith-art]
* Blog from Kiyonori Nagasaki of the University of Tokyo, on [use of the new University of Toronto IIIF and Mirador plugin for Omeka in the Japanese DH classroom][kiyonori]
* Polonski Project blog on [Revisiting the Ars Moriendi using Mirador][polonsky]
* Article from Digirati on [IIIF Search and Discovery][digirati-search]
