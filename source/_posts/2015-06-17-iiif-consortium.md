...
By adopting the IIIF and becoming part of the community, institutions gain access to well supported and sustainable technologies, and enrich scholarly use of their materials.  For more information, visit [{{ site.url }}{{ site.baseurl }}]({{ page.webprefix }}).


About IIIF | [{{ site.url }}{{ site.baseurl }}]({{ page.webprefix }})
