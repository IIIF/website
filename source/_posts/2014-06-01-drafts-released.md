 ...
 * [IIIF Image API 2.0.0-draft1]({{ page.webprefix }}/api/image/2.0/)
 * [IIIF Presentation API 2.0.0-draft1]({{ page.webprefix }}/api/presentation/2.0/)
 ...
 * [Image API 2.0 Change Log]({{ page.webprefix }}/api/image/2.0/change-log/)
 * [Presentation API 2.0 Change Log]({{ page.webprefix }}/api/presentation/2.0/change-log/)
