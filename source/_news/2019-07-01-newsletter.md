...
OpenLayers 6 will support IIIF Image API services OpenLayers is a JavaScript library for building feature rich map and geo data web applications. Upcoming version 6 will allow the usage of IIIF Image API services as map tile sources.
