...
By adopting the IIIF and becoming part of the community, institutions gain access to well supported and sustainable technologies, and enrich scholarly use of their materials.  For more information, visit [{{ site.root_url | absolute_url }}]({{ site.root_url | absolute_url }}).


About IIIF | [{{ site.root_url | absolute_url }}]({{ site.root_url | absolute_url }})
