...
The IIIF Code of Conduct covers our behavior as members of the IIIF Community in any forum, including the [IIIF-Discuss][iiif-discuss]{:.external} email list, [IIIF Slack][iiif-slack]{:.external} team and channels, [GitHub][github]{:.external}, remote and in-person meetings, or private correspondence related to IIIF. IIIF is an inclusive, friendly and safe community, committed to openness and transparency in all interactions and activities. To reflect these commitments, we agree to operate under the following community norms:
...
Individuals who violate these guidelines will be notified and asked to change their behavior. Repeated violations may result in loss of membership in project groups, revocation of special access to project resources, and/or loss of access to project communication channels ([IIIF-Discuss][iiif-discuss]{:.external} email list, [Slack][iiif-slack]{:.external}, [GitHub][github]{:.external}, and others). Repeat offenders may be asked to stop participating in the project or directed to filter their participation through another member of their institution (if applicable).
...
* A message will go out to the [IIIF-Discuss][iiif-discuss]{:.external} email list calling for individuals to serve for two years on the IIIF Code of Conduct Team. The call for volunteers will remain open for one month (4 weeks).
* Individuals will express their willingness to volunteer via an [online form][volunteer-form]{:.external}, with timestamp.
