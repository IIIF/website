...
The [IIIF Authentication Technical Specification Group charter]({{ site.url }}{{ site.baseurl }}/community/groups/auth-tsg/charter/index.html) provides an outline and timeline for anticipated work.
