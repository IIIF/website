...
### Technical Specification Group Formation and Approval
  ...
  * The IIIF Technical Coordinator will facilitate the creation of the document, ensure that the process requirements are met, and that the details within it are accurate. When the community agrees that it is ready to be proposed for approval, the IIIF Technical Coordinator will take it to the Technical Review Committee (TRC) for review.
