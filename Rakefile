...
task :check_html do
  HTMLProofer.check_directory('./_site', check_html: true,
                                         ...
                                         url_ignore: ['https://vimeo.com/229253706?ref=tw-share', 'http://ksn.io','http://www.irht.cnrs.fr',
                                          ...
                                          /https:\/\/www.qdl.qa.*/,/https:\/\/www.europeana.eu.*/,'https://www.artic.edu/', /https:\/\/theinnatbrookline.reztrip.com*/, /https:\/\/www.researchgate.net*/, /https:\/\/eap.bl.uk*/, /https:\/\/www.medievalacademy.org*/]
                                          ).run
end
